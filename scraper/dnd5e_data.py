...
DND5E_FEATURES = {
    "racial": [
        ...
        (
            "Darkvision",
            "You can see in dim light within 60 feet as if it were "
        ...
        (
            "Stonecunning",
            "You have proficiency with mason's tools and double "
            "your proficiency bonus on History checks related to "
            "stonework.",
        ),
        (
            "Draconic Ancestry",
            "You have draconic ancestry. Choose one type of "
            "dragon; this determines the damage and area of "
            "your breath weapon.",
        ),
        (
            "Breath Weapon",
            "You can use your action to exhale destructive energy "
            "determined by your draconic ancestry.",
        ),
        (
            "Damage Resistance",
        ...
        (
            "Trance",
            "You don't need to sleep and can't be forced to sleep. "
            "Instead, you meditate deeply for 4 hours.",
        ),
        (
            "Extra Language",
        ...
        (
            ...
            "and can construct tiny clockwork devices.",
        ),
        (
        ...
        (
            "Infernal Legacy",
            "You know the thaumaturgy cantrip. Once you reach "
            "3rd level, you can cast hellish rebuke once per day.",
        ),
    ],
    "class": [
        # Barbarian
        (
            "Rage",
            "In battle, you fight with primal ferocity. You have advantage "
            "on Strength checks and saving throws, bonus melee damage, and "
            "resistance to bludgeoning, piercing, and slashing damage.",
        ),
        (
            "Unarmored Defense (Barbarian)",
            "While not wearing armor, your AC "
            "equals 10 + Dex modifier + Con modifier.",
        ),
        (
            "Reckless Attack",
            "You can throw aside all concern for defense to "
            "attack with fierce desperation, gaining advantage "
            "on melee weapon attack rolls but giving attackers "
        ...
        (
            ...
            "music, giving them a d6 to add to one ability "
            "check, attack roll, or saving throw.",
        ),
        (
            "Jack of All Trades",
            "You can add half your proficiency bonus to any "
            "ability check that doesn't already include your "
            "proficiency bonus.",
        ),
        (
            "Song of Rest",
            "During a short rest, any creatures who hear your "
            "performance regain extra hit points.",
        ),
        ...
        (
            "Divine Intervention",
            "You can call on your deity to intervene on your "
        ...
        (
            ...
            "beast that you have seen before.",
        ),
        (
            "Natural Recovery",
        ...
        (
            "Martial Arts",
            "You gain benefits while unarmed or wielding only monk weapons and "
        ...
        (
            ...
            "your AC equals 10 + Dex modifier + Wis modifier.",
        ),
        (
            "Deflect Missiles",
            "You can use your reaction to deflect or catch missiles "
            "when hit by a ranged weapon attack.",
        ),
        (
            "Slow Fall",
        ...
        (
            ...
            "can expend one spell slot to deal radiant damage.",
        ),
        (
            "Aura of Protection",
            "You and friendly creatures within 10 feet gain a "
            "bonus to saving throws equal to your Charisma modifier.",
        ),
        # Ranger
        (
            "Favored Enemy",
            "You have studied, tracked, and learned to effectively "
            "fight a specific type of creature.",
        ),
        (
            "Natural Explorer",
        ...
        (
            "Primeval Awareness",
            "You can use your action to focus your awareness on "
        ...
        (
            "Cunning Action",
            "You can take a Dash, Disengage, or Hide action as a bonus action.",
        ),
        (
            "Uncanny Dodge",
            "When an attacker that you can see hits you with an attack, you can "
            "use your reaction to halve the attack's damage.",
        ),
        (
            "Evasion",
            "When you are subjected to an effect that allows you to make a "
            "Dexterity saving throw to take only half damage, you instead "
            "take no damage if you succeed.",
        ),
        # Sorcerer
        (
            "Sorcerous Origin",
            "Choose a sorcerous origin, which describes the source "
            "of your innate magical power.",
        ),
        ...
        (
            "Pact Magic",
            "Your arcane research and magic bestowed by your patron have "
            "given you facility with spells.",
        ),
        (
            "Eldritch Invocations",
            "You learn occult secrets called eldritch " "invocations.",
        ),
        (
            "Pact Boon",
        ...
        (
            ...
            "reality in harmony with your wishes and music.",
        ),
        (
            "Ritual Casting",
    ...
    "background": [
        (
            ...
            "you access to a unique and powerful discovery.",
        ),
        (
            "Feature: Shelter of the Faithful",
            "You and your companions can expect to "
            "receive free healing and care at a temple, shrine, or other established "
            "presence of your faith.",
        ),
        (
            "Feature: Guild Membership",
            "As an established and respected member of a "
            "guild, you can rely on certain benefits.",
        ),
        (
            "Feature: Position of Privilege",
            "Thanks to your noble birth, people are "
            "inclined to think the best of you.",
        ),
        (
            "Feature: Ship's Passage",
            "When you need to, you can secure free passage "
            "on a sailing ship for yourself and your companions.",
        ),
        (
            "Feature: Safe Haven",
            "You have a reliable and trustworthy contact who "
            "acts as your liaison to a network of other criminals.",
        ),
        (
            "Feature: Wanderer",
...
DND5E_EQUIPMENT = {
    "weapons": [
        ...
        (
            ...
            2,
            1.0,
            "A sharp knife, ideal for close combat or throwing.",
        ),
    ...
    "armor": [
        ...
        (
            ...
            50,
            45.0,
            "A coat and leggings of leather covered with overlapping pieces of metal.",
        ),
    ...
    "adventuring_gear": [
        ...
        (
            ...
            25,
            1.0,
            "This set includes a small file, lock picks, a small mirror, and "
        ...
        (
            ...
            5,
            3.0,
            "This kit has ten uses and can stabilize dying creatures.",
        ),
        (
            "Disguise Kit",
            "tool",
            25,
            3.0,
            "This pouch contains cosmetics, hair dye, and small props.",
        ),
        (
            "Forgery Kit",
            "tool",
            15,
            5.0,
            "This small box contains paper, inks, and other supplies.",
        ),
        (
            "Herbalism Kit",
            "tool",
            5,
            3.0,
            "This kit contains pouches to store herbs and tools to harvest them.",
        ),
        (
            "Poisoner's Kit",
            "tool",
            50,
            2.0,
            "This kit includes vials, chemicals, and other equipment.",
        ),
        # Consumables
        (
            "Potion of Healing",
            ...
            50,
            0.5,
            "A character who drinks this magical red fluid regains 2d4 + 2 hit points.",
        ),
        (
            "Antitoxin",
            "consumable",
            50,
            0.0,
            "A creature that drinks this vial has advantage on saving throws "
        ...
        (
            ...
            25,
            1.0,
            "As an action, you can splash this flask on a creature within 5 feet "
        ...
        (
            ...
            25,
            1.0,
            "As an action, you can splash this acid on a creature within 5 feet.",
        ),
        (
            "Alchemist's Fire",
            "consumable",
