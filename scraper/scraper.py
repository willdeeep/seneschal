...
class ScraperOrchestrator:
    ...
    def __init__(self):
        ...
        if (
            SCRAPE_CONFIG.get("races")
            or SCRAPE_CONFIG.get("classes")
            or SCRAPE_CONFIG.get("equipment")
            or SCRAPE_CONFIG.get("spells")
            or SCRAPE_CONFIG.get("skills")
        ):
        ...
        for data_type, items in results.items():
            if items:
                ...
                try:
                    ...
                    self.logger.error(
                        "Failed to save combined %s data: %s", data_type, e
                    )
