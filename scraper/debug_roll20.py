            ...
            try:
                async with session.get(url) as response:
                    ...
                    if found_containers:
                        ...
                        print(
                            f"Using container: {main_container.name} with class='{main_container.get('class')}' id='{main_container.get('id')}'"
                        )
                        ...
                        print(
                            f"Found {len(content_divs)} divs with substantial content"
                        )
                        if content_divs:
                            largest_div = content_divs[0][0]
                            print(
                                f"Largest content div: class='{largest_div.get('class')}' id='{largest_div.get('id')}' ({content_divs[0][1]} chars)"
                            )
